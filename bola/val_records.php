 ...
 $errors =array();
    ...
    if (isset($_POST['submit'])) {
      ...
      if(empty($_POST['sender_name'])){
        echo "<p style='color:red;'>Sender Name is required</p>";
      }
       else
      if(empty($_POST['receipient_name'])){
        echo "<p style='color:red;'>Receipient Name is required</p>";
      }
        else
      if(empty($_POST['reciepient_division'])){
        echo "<p style='color:red;'>reciepient division is required</p>";
      }
   else
      if(empty($_POST['doc_intro'])){
        echo "<p style='color:red;'>Document Introduction is required</p>";
      }
