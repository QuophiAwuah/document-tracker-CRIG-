...
<?php
  if(!isset($_SESSION['product_username']) || !isset($_SESSION['product_password'])){
     header('Location: login.php');
  }
 ?>

<?php include '../div_query/product_query.php' ?>
...
<a class="navbar-brand  brand" href="index.php" title="ProBootstrap:Enlight">NEW PRODUCTS</a>
</div>
<?php $in = mysqli_num_rows($product_in)?>
<div id="navbar-collapse" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
          <li><a href="#">Documents~<span class="badge badge-success"><?=$total_product ?></span></a></li>
          <li><a href="#">Inbox~<span class="badge badge-success"><?=$count_product2 ?></span></a></li>
          <li><a href="#">Outbox~<span class="badge badge-success"><?=$count_product1; ?></span></a></li>
          </ul>
</div>
</div>
</nav>
      ...
      <div class="col-md-3">
        <div class="panel">
          <div class="panel-heading">
              All Documents <span class="badge badge-warning"><?=$total_product ?></span>
            </div>
...
<!-- confirm Recieved documnet -->
  <div id="menu1" class="tab-pane fade">
    <h4>New Products Documents</h4><hr>
   <div class="panel">
    <div class="panel-heading">
    ...
    <div id="collapse2" class="panel-collapse collapse">
      <div class="panel-body">
        ...
        <table class="table table-striped table-condensed">
          ...
          <tbody>
            <?php while($P = mysqli_fetch_assoc($product_out)): ?>
            <tr class="bg-info">
              <td><?=$P['doc_id']?></td>
              <td><?=$P['sender_name']?></td>
  ...
  <h3>New Products Document</h3><hr>
    ...
    <div id="collapse1" class="panel-collapse collapse in">
      <div class="panel-body">
        ...
        <table class="table table-striped table-condensed">
          ...
          <tbody>
            <?php while($P = mysqli_fetch_assoc($product_in)): ?>
            <tr class="bg-info">
              <td><?=$P['doc_id']?></td>
              <td><?=$P['sender_name']?></td>
              <td><?=$P['sender_division']?></td>
