...
<?php
  if(!isset($_SESSION['aud_username']) || !isset($_SESSION['aud_password'])){
...
<a class="navbar-brand  brand" href="index.php" title="ProBootstrap:Enlight">Audit</a>
</div>
<div id="navbar-collapse" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
          <li><a href="#">Documents~<span class="badge badge-success"><?=$total_aud ?></span></a></li>
          <li><a href="#">Inbox~<span class="badge badge-success"><?=$count_aud2 ?></span></a></li>
          <li><a href="#">Outbox~<span class="badge badge-success"><?=$count_aud1; ?></span></a></li>
          </ul>
</div>
</div>
</nav>
      ...
      <div class="col-md-3">
        <div class="panel">
          <div class="panel-heading">
              All Documents<span class="badge badge-warning"><?=$total_aud ?></span>
            </div>
    ...
    <div id="collapse2" class="panel-collapse collapse">
      <div class="panel-body">
        ...
        <table class="table table-striped table-condensed">
          ...
          <tbody>
            <?php while($P = mysqli_fetch_assoc($aud_out)): ?>
            <tr class="bg-info">
              <td><?=$P['doc_id']?></td>
              <td><?=$P['sender_name']?></td>
    ...
    <div id="collapse1" class="panel-collapse collapse in">
      <div class="panel-body">
        ...
        <table class="table table-striped table-condensed">
          ...
          <tbody>
            <?php while($P = mysqli_fetch_assoc($aud_in)): ?>
            <tr class="bg-info">
              <td><?=$P['doc_id']?></td>
              <td><?=$P['sender_name']?></td>
              <td><?=$P['sender_division']?></td>
