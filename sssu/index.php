...
<?php
  if(!isset($_SESSION['sssu_username']) || !isset($_SESSION['sssu_password'])){
     header('Location: login.php');
  }
 ?>

<?php include '../div_query/sssu_query.php' ?>
...
<a class="navbar-brand  brand" href="index.php" title="ProBootstrap:Enlight">SSSU</a>
</div>
<?php $in = mysqli_num_rows($sssu_in)?>
<div id="navbar-collapse" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
          <li><a href="#">Documents~<span class="badge badge-success"><?=$total_sssu ?></span></a></li>
          <li><a href="#">Inbox~<span class="badge badge-success"><?=$count_sssu2 ?></span></a></li>
          <li><a href="#">Outbox~<span class="badge badge-success"><?=$count_sssu1; ?></span></a></li>
          </ul>
</div>
</div>
</nav>
      ...
      <div class="col-md-3">
        <div class="panel">
          <div class="panel-heading">
              All Documents<span class="badge badge-warning"><?=$total_sssu ?></span>
            </div>
    ...
    <div id="collapse2" class="panel-collapse collapse">
      <div class="panel-body">
        ...
        <table class="table table-striped table-condensed">
          ...
          <tbody>
            <?php while($P = mysqli_fetch_assoc($sssu_out)): ?>
            <tr class="bg-info">
              <td><?=$P['doc_id']?></td>
              <td><?=$P['sender_name']?></td>
    ...
    <div id="collapse1" class="panel-collapse collapse in">
      <div class="panel-body">
        ...
        <table class="table table-striped table-condensed">
          ...
          <tbody>
            <?php while($P = mysqli_fetch_assoc($sssu_in)): ?>
            <tr class="bg-info">
              <td><?=$P['doc_id']?></td>
              <td><?=$P['sender_name']?></td>
              <td><?=$P['sender_division']?></td>
