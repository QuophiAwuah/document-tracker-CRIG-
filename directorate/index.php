...
<?php
  if(!isset($_SESSION['dir_username']) || !isset($_SESSION['dir_password'])){
     header('Location: login.php');
  }
 ?>

<?php include '../div_query/dir_query.php' ?>
...
<a class="navbar-brand  brand" href="index.php" title="ProBootstrap:Enlight">Directorate</a>
</div>
<?php $in = mysqli_num_rows($dir_in)?>
<div id="navbar-collapse" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
          <li><a href="#">Documents~<span class="badge badge-success"><?=$total_dir ?></span></a></li>
          <li><a href="#">Inbox~<span class="badge badge-success"><?=$count_dir2 ?></span></a></li>
          <li><a href="#">Outbox~<span class="badge badge-success"><?=$count_dir1; ?></span></a></li>
          </ul>
</div>
</div>
</nav>
      ...
      <div class="col-md-3">
        <div class="panel">
          <div class="panel-heading">
              All Documents<span class="badge badge-warning"><?=$total_dir ?></span>
            </div>
...
<!-- confirm Recieved documnet -->
  <div id="menu1" class="tab-pane fade">
    <h4>Directorate Documents</h4><hr>
   <div class="panel">
    <div class="panel-heading">
    ...
    <div id="collapse2" class="panel-collapse collapse">
      <div class="panel-body">
        ...
        <table class="table table-striped table-condensed">
          ...
          <tbody>
            <?php while($P = mysqli_fetch_assoc($dir_out)): ?>
            <tr class="bg-info">
              <td><?=$P['doc_id']?></td>
              <td><?=$P['sender_name']?></td>
    ...
    <div id="collapse1" class="panel-collapse collapse in">
      <div class="panel-body">
        ...
        <table class="table table-striped table-condensed">
          ...
          <tbody>
            <?php while($P = mysqli_fetch_assoc($dir_in)): ?>
            <tr class="bg-info">
              <td><?=$P['doc_id']?></td>
              <td><?=$P['sender_name']?></td>
              <td><?=$P['sender_division']?></td>
